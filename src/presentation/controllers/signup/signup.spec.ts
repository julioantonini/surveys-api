...
describe("signUp Controller", () => {
  ...
  test("Shoud return 400 if no e-mail is provided", () => {
    const { sut } = makeSut();
    const httpRequest = {
      body: {
        name: "any_name",
  ...
  test("Shoud return 400 if an a invalid email is provided", () => {
  ...
  test("Shoud return 500 if email validator throw", () => {
    const { sut, emailValidatorStub } = makeSut();
  ...
  test("Shoud return 500 if addAccount throw", () => {
